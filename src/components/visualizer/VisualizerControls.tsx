...
// Play / Pause / Restart / Prev / Next + speed control.
export function VisualizerControls({ pb }: { pb: Playback }) {
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <Btn onClick={pb.toggle} primary disabled={pb.atEnd && !pb.playing}>
        ...
        {SPEEDS.map((s) => (
          <button
            ...
            className={`rounded px-2 py-1 text-xs font-medium transition ${
              pb.speed === s ? "bg-indigo-600 text-white" : "text-neutral-400 hover:bg-neutral-800"
            }`}
          >
            {s}x
          </button>
